...
pub mod request {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_cmd(self) -> ::core::result::Result<crate::kv_capnp::Cmd,::capnp::NotInSchema> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_cmd(&mut self, value: crate::kv_capnp::Cmd)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 62] = [
      ...
      ::capnp::word(84, 92, 69, 165, 97, 98, 211, 140),
      ::capnp::word(16, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(79, 251, 194, 14, 211, 47, 31, 218),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(115, 99, 104, 101, 109, 97, 47, 107),
      ::capnp::word(118, 46, 99, 97, 112, 110, 112, 58),
      ...
      ::capnp::word(5, 160, 58, 94, 114, 178, 150, 160),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(15, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <crate::kv_capnp::Cmd as ::capnp::introspect::Introspect>::introspect(),
    ...
    pub const TYPE_ID: u64 = 0x8cd3_6261_a545_5c54;
  }
}
...
pub mod response {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_status(self) -> ::capnp::Result<::capnp::text::Reader<'a>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_status(self) -> ::capnp::Result<::capnp::text::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_status(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false).unwrap()
    }
    #[inline]
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 48] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(226, 230, 122, 159, 249, 34, 165, 171),
    ...
    pub const TYPE_ID: u64 = 0xaba5_22f9_9f7a_e6e2;
  }
}
...
impl ::capnp::introspect::Introspect for Cmd {
  fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema { encoded_node: &cmd::ENCODED_NODE, annotation_types: cmd::get_annotation_types }).into() }
}
impl ::core::convert::From<Cmd> for ::capnp::dynamic_value::Reader<'_> {
  fn from(e: Cmd) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema { encoded_node: &cmd::ENCODED_NODE, annotation_types: cmd::get_annotation_types }.into()).into() }
}
impl ::core::convert::TryFrom<u16> for Cmd {
  type Error = ::capnp::NotInSchema;
  fn try_from(value: u16) -> ::core::result::Result<Self, <Cmd as ::core::convert::TryFrom<u16>>::Error> {
    match value {
      0 => ::core::result::Result::Ok(Self::Set),
      1 => ::core::result::Result::Ok(Self::Get),
      2 => ::core::result::Result::Ok(Self::Del),
...
impl From<Cmd> for u16 {
  #[inline]
  fn from(x: Cmd) -> u16 { x as u16 }
}
impl ::capnp::traits::HasTypeId for Cmd {
  const TYPE_ID: u64 = 0xa096_b272_5e3a_a005u64;
}
mod cmd {
pub static ENCODED_NODE: [::capnp::Word; 29] = [
  ...
  ::capnp::word(115, 99, 104, 101, 109, 97, 47, 107),
  ::capnp::word(118, 46, 99, 97, 112, 110, 112, 58),
  ::capnp::word(67, 109, 100, 0, 0, 0, 0, 0),
  ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
